...
const FormContentEducation = (props) => {
  ...
  return (
    <div className="form-inner">
      <h3>{props.id ? 'Edit Education Details' : 'Add Education Details'}</h3>
      <form method="post">
        ...
        <div className="form-group">
          <label>From Date <span className="required">(required)</span></label><br />
          <DatePicker 
            selected={fromDate} 
            maxDate={new Date()}
        ...
        <div className="form-group">
          <label>To Date <span className="required">(required)</span></label><br />
          {/* <input
            type="date"
            name="to Date"
            placeholder="To Date"
