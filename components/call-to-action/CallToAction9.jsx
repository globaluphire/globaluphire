                ...
                <div className="row grid-base justify-content-center">
                    <div className="col-lg-6 col-md-10">
                        <div className="sec-title light text-center">
                            ...
                            <div className="text">
                                Superio offers a way to completely optimize your
                                entire recruiting process. Find better
                                candidates, conduct more focused interviews, and
                        ...
                        <div className="btn-box">
                            <Link
                                href="/register"
                                className="theme-btn btn-white-type-2"
                            >
                                GET STARTED
                            </Link>
                        </div>
