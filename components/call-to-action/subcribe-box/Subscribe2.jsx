                    ...
                    <div className="col-lg-5 col-md-10" data-aos="fade-right">
                        <div className="sec-title light mb-0 pb-20">
                            <h2 className="text-white">
                                Get Matched The Most Valuable Jobs, Just Drop
                                Your Cv at Superio
                            </h2>
                            <div className="text text-white">
                                The template is really nice and offers quite a
                                large set of options. It’s beautiful and the
                                coding is done quickly and seamlessly. Thank
                                you!
                            </div>
