                ...
                <div className="row grid-base">
                        ...
                        <div className="inner-column " data-aos="fade-right">
                            <div className="sec-title">
                                ...
                                <div className="text">
                                    ...
                                    do eiusmod tempor incididunt. Labore et
                                    dolore magna aliqua. Ut enim ad minim
                                    veniam, quis nostrud exercitation.Letraset
                                    sheets containing Lorem Ipsum passages, and
                                    more recently with desktop publishing.
                                </div>
                                <div className="text">
                                    Software like Aldus PageMaker including
                                    versions of Lorem Ipsum. There are many
                    ...
                    >
                        <figure className="image-box">
                            <img
                                src="images/index-11/text/image-2.png"
                                alt="about"
                            />
                        </figure>
