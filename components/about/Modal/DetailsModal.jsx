        ...
        <div className="modal fade" id="details-modal">
            <div className="modal-dialog modal-dialog-centered modal-xl">
                <div className="apply-modal-content modal-content">
                    ...
                    >
                        <div>
                            This nursing assistant course is a 117-hour course.
                        ...
                        <ul className="list-style-one mt-3">
                            <li>
                                Must be 18 years old by the training graduation
                                date.
                            </li>
                            <li>Pass a Criminal Background Check</li>
                            <li>
                                Must be able to read and understand simple and
                                verbal instructions in English{" "}
                            </li>
                            <li>Must be eligible to work in the US </li>
                            <li>
                                Must be fully vaccinated against COVID-19 OR
                        ...
                        <div className="mt-3">
                            For a limited time, Volare Health Care-Oregon is
                            offering this course with FREE tuition to accepted
                            applicants. <br /> This <strong>FREE</strong> class
                            includes:
                        ...
                        <strong>
                            Students are responsible for Oregon State Board of
                            Nursing Exam Fees:{" "}
                        </strong>
                        <div>
                            Once the course is successfully completed, the
                            student is eligible to take the state certification
                            exam. Oregon State Board of Nursing charges each
                            candidate a fee of $106.00 for the exam, plus $70.50
                            for the fingerprint processing. The student is
                            responsible for the cost of the state exam fee and
                            fingerprinting fee. If accepted into our class and
                            hired at one of our locations, you will be
                            reimbursed for the cost once you are officially on
                            our payroll. We will require a receipt to provide
                            the reimbursement.
                        </div>
