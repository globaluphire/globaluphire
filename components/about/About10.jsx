                            ...
                            <div className="wow fadeInLeft">
                                <div className="sec-title mb-0">
                                    ...
                                    <div className="text mt-36 md:mt-16">
                                        Praesent sollicitudin felis a ornare
                                        volutpat. Nullam malesuada sem sit amet
                                        semper tristique. Donec nec neque
                                        lectus. Nunc mattis, lectus eu lacinia
                                        pre tium, nisl nisi interdum tortor.
                                    </div>
                                </div>
                                <a
                                    href="#"
                                    className="theme-btn -blue-outline mt-56 md:mt-16"
                                >
                                    All Services
                                </a>
                            </div>
