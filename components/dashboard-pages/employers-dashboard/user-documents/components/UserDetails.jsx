        ...
        <div className="post-job-steps">
            <div className="step">
                ...
                <div>
                    ...
                    <small>
                        <a
                            href={
                                JSON.parse(applicantData?.doc_dwnld_url)
                                    ?.publicUrl
                            }
                            style={{
                                display: "flex",
            ...
            <div className="step">
                ...
                <div>
                    ...
                    {applicantData?.status.toLowerCase() === "hired" && (
                        <small>
                            {" "}
                            @{" "}
                            {new Date(
                                applicantData?.hired_date
                            ).toLocaleDateString()}
                        </small>
                    )}
                    {applicantData?.status.toLowerCase() === "reject" && (
                        <small>
                            {" "}
                            @{" "}
                            {new Date(
                                applicantData?.rejected_date
                            ).toLocaleDateString()}
                        </small>
                    )}
                </div>
