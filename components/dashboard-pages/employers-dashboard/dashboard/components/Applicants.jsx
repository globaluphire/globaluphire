      ...
      let arrData = [];
          for (const item of unique) {
            ...
            if(fetchUser){
              ...
              if(fetchUser.data && fetchUser.data.length > 0 && fetchUser.data[0].user_photo != null){
                photo_url = cloudPath+fetchUser.data[0].user_photo;
              } else if(fetchUser.data && fetchUser.data.length > 0 && fetchUser.data[0].photo_url != null){
