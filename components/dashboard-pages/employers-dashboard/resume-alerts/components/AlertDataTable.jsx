    ...
    <div>
          ...
          <div>
            <div className="search-box-one">
              ...
              <div className="form-group pull-left mb-3" style={{ fontSize: '1.5rem', fontWeight: '500' }}>
                  <b>Resume Alerts!</b>
              </div>
            ...
            {
              isLoading == false && userData.length == 0 && <p style={{ fontSize: '1rem', fontWeight: '500', paddingBottom: 40, paddingTop: 40, textAlign: 'center' }}><center>No resume alert  yet!</center></p>
            }
            {
