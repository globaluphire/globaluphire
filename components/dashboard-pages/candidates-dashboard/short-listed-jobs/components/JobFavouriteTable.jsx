          ...
          <div className="table-outer">
            <div className="table-outer">
              <table className="default-table manage-job-table">
                ...
                {shortlistedJobs.length == 0 ? <tbody style={{ fontSize: '1.5rem', fontWeight: '500' }}><tr><td><b>No Shortlisted Job(s)!</b></td></tr></tbody>: 
                  <tbody>
                        ...
                        <td>
                          <div className="option-box">
                            <ul className="option-list">
                              ...
                              <li onClick={() => { unShortListJob(item.job_id) }}>
                                <button data-text="Remove from Shortlist" className="bookmark-btn-filled">
