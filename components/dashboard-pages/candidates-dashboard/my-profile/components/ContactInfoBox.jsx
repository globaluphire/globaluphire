...
const ContactInfoBox = () => {
  ...
  const submitContactInfo = async () => {
    try {
      ...
      // open toast
      toast.error('Error while saving your contact info, Please try again later or contact tech support', {
        position: "bottom-right",
        autoClose: true,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    <form className="default-form">
      <div className="row">
        ...
        <div className="form-group col-lg-12 col-md-12">
          ...
          <a data-tooltip-id="address-tooltip" data-tooltip-content="Address should be in: 123 Stree Name, City, State ZipCode">
