...
const FormInfoBox = () => {
    ...
    const handleMultipleValues = (selectedValues) => {
        ...
        if (selectedString !== "") {
            selectedString = selectedString.substring(
                0,
        ...
        try {
            if (userID) {
                ...
                if (userData) {
                    ...
                    // fetch user details
                    const userDtlData = await supabase
                        .from("users_dtl")
                        .select("*")
                        .eq("user_id", userID);
                    if (userDtlData) {
            ...
            toast.error(
                "System is unavailable to fetch customer.  Please try again later or contact tech support!",
                {
    ...
    const submitCandidateProfile = async () => {
        if (name && phone && email && experience && education) {
            try {
                ...
                toast.error(
                    "Error while saving your company profile, Please try again later or contact tech support",
                    {
                        position: "bottom-right",
                        autoClose: true,
                        hideProgressBar: false,
                ...
                <div className="form-group col-lg-6 col-md-12">
                    <label>
                        ...
                        <a
                            ...
                            data-tooltip-content="Phone number should be in +1123456890"
                        >
                            <span
                    ...
                    <div style={{ marginTop: "-25px" }}>
                        <span className="optional">
                            (By entering your number here, allows Employer to
                            reach out about status of your applied job and setup
                            interview if you sort listed!)
                        </span>
                    </div>
                </div>
                ...
                <div className="form-group col-lg-6 col-md-12">
                    <label>
                        ...
                        <a
                            ...
                            data-tooltip-content="How many years of Experience do you have? Ex. Freshers or 5 Years"
                        >
                            <span
                                className="lar la-question-circle"
                                style={{ fontSize: "14px", margin: "5px" }}
          ...
          />
                ...
                <div className="form-group col-lg-12 col-md-12">
                    ...
                    <a
                        ...
                        data-tooltip-content="Describe about yourself!"
                    >
                        <span
                            className="lar la-question-circle"
                            style={{ fontSize: "14px", margin: "5px" }}
