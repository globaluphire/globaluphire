  ...
  return (
    <>
      <div className="text-box">
        <h3>THIS AGREEMENT GOVERNS YOUR USE OF Global UpHire LLC. HOSTED SERVICES.</h3>
        <p>
        ...
        <p>
          You may not access the Hosted Services if You are Global UpHire’s direct competitor, except with Global UpHire’s prior written consent. In addition, you may not access the Hosted Services for purposes of monitoring their availability, performance or functionality, or for any other benchmarking or competitive purposes.
        </p>
        <p>
          This agreement was last updated on Apr 11, 2023 (“Agreement”). It is effective between You and Global UpHire LLC. as of the date of You accepted this Agreement (the “Effective Date“).
        </p>
        <p>
      ...
      <div className="text-box">
        ...
        <p>
          “Customer Trademarks” means any trademarks that Customer provides Global UpHire for the purpose of referring to Customer within the user interface for the Hosted Service.
        </p>
        <p>
          “Dispute Period” means fifteen (15) days from receipt of invoice.
        </p>
        <p>
          “Documentation” means Global UpHire’s then current on-line help, guides, and manuals published by Global UpHire and made generally available by Global UpHire for the Hosted Services. Documentation shall include any updated Documentation that Global UpHire provides.
        </p>
        <p>
        ...
        <p>
          “Order Form” means the ordering documents for Customer purchases from Global UpHire that are executed hereunder by Customer and Global UpHire from time to time. All Order Forms shall be deemed incorporated herein. The initial Order Form is attached hereto as Exhibit A.
        </p>
        <p>
      ...
      <div className="text-box">
        <h3>4. OWNERSHIP</h3>
        <p>
          4.1 &nbsp;&nbsp;&nbsp; Global UpHire shall own and retain all right, title and interest in and to the Hosted Services and Global UpHire Confidential Information (defined below), including all intellectual property rights. No rights are granted to Customer hereunder other than as expressly set forth herein.
        </p>
        <p>
          4.2 &nbsp;&nbsp;&nbsp; Global UpHire shall have a royalty-free, worldwide, transferable, sublicensable, irrevocable, perpetual license to use or incorporate into the Hosted Services any suggestions, enhancement requests, recommendations or other feedback provided by Customer, including Users, relating to the operation of the Hosted Services.
        </p>
      </div>
      ...
      <div className="text-box">
        <h3>6. SUPPORT</h3>
        <p>
          For the Subscription Term Global UpHire shall provide assistance to Customer by telephone, e-mail or online chat as communicated to Customer. Global UpHire shall use reasonable commercial efforts to correct at no additional charge any reproducible errors reported by Customer. Global UpHire shall review all requests for improvements and new functionality, but Global UpHire shall have no obligation to provide any modifications to the Hosted Service.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          9.1 &nbsp;&nbsp;&nbsp; IN NO EVENT SHALL THE AGGREGATE LIABILITY OF Global UpHire OR ITS THIRD-PARTY PROVIDERS EXCEED THE TOTAL AMOUNTS ACTUALLY PAID BY AND/OR DUE FROM CUSTOMER IN THE TWELVE (12) MONTH PERIOD IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO SUCH CLAIM.
        </p>
        <p>
          9.2 &nbsp;&nbsp;&nbsp; IN NO EVENT SHALL EITHER PARTY OR THIRD-PARTY PROVIDERS OF Global UpHire BE LIABLE TO ANYONE FOR ANY INDIRECT, PUNITIVE, SPECIAL, EXEMPLARY, INCIDENTAL, OR CONSEQUENTIAL DAMAGES, OR FOR ANY DAMAGES FOR LOSS OF DATA, REVENUE, PROFITS, USE OR OTHER ECONOMIC ADVANTAGE, ARISING OUT OF, OR IN ANY WAY CONNECTED WITH THIS AGREEMENT, INCLUDING BUT NOT LIMITED TO THE USE OR INABILITY TO USE THE HOSTED SERVICE, REGARDLESS OF CAUSE, WHETHER IN AN ACTION IN CONTRACT OR NEGLIGENCE OR OTHER TORTIOUS ACTION, EVEN IF THE PARTY FROM WHICH DAMAGES ARE BEING SOUGHT OR THE THIRD-PARTY PROVIDER HAVE BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
        </p>
        <p>
          9.3 &nbsp;&nbsp;&nbsp; THE LIMITATION OF LIABILITY SET FORTH IN THIS SECTION 9 SHALL NOT APPLY IN THE EVENT OF CUSTOMER’S INFRINGEMENT OR MISAPPROPRIATION OF Global UpHire’S INTELLECTUAL PROPERTY RIGHTS, OR TO CUSTOMER’S INDEMNITY OBLIGATIONS SET FORTH IN SECTION 10 BELOW. CERTAIN STATES AND/OR JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF IMPLIED WARRANTIES OR LIMITATION OF LIABILITY FOR INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE EXCLUSIONS SET FORTH ABOVE MAY NOT APPLY.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          10.1 &nbsp;&nbsp;&nbsp; Indemnification by Global UpHire.  Global UpHire shall defend, indemnify and hold Customer harmless against any “Claims” made or brought against Customer by a third party alleging that (i) the use of the Hosted Service as contemplated hereunder infringes the copyrights, trademarks or trade secrets of such third party; or (ii) Global UpHire failed to comply with applicable laws, rules or regulations in its performance of this Agreement; provided, that Customer (a) promptly gives written notice of the Claim to Global UpHire; (b) gives Global UpHire control of the defense and settlement of the Claim (provided that Customer may participate in such defense at its own expense and that Global UpHire may not settle any Claim in a manner that admits liability on behalf of Customer); and (c) provides to Global UpHire, at Global UpHire’s expense, reasonable assistance in connection with the defense and settlement of the Claim. Global UpHire shall pay Customer any damages finally awarded against Customer, settlements agreed to in accordance with Section 10.1(b) and reasonable costs and expenses (including reasonable legal fees) directly attributable to such Claim.
        </p>
        <p>
          10.1.1 &nbsp;&nbsp;&nbsp; Global UpHire may, at its sole option and expense: (i) procure for Customer the right to continue using the Hosted Service under the terms of this Agreement; or (ii) replace or modify the Hosted Service to be non-infringing without material decrease in functionality.  If the foregoing options are not reasonably practicable, Global UpHire may terminate this Agreement and refund to Customer all prepaid fees for the remainder of its subscription term after the date of termination.  This Section 10 represents Global UpHire’s entire obligation and Customer’s exclusive remedy regarding any third party intellectual property claims.
        </p>
        <p>
          10.1.2 &nbsp;&nbsp;&nbsp; Furthermore, Global UpHire shall have no liability for any Claim under Section 10.1(i) to the extent such liability is the result of (i) modifications to the Hosted Service by anyone other than Global UpHire or its agents (provided that Global UpHire shall not be liable if Global UpHire or its agents made the modifications using requirements documents, written specifications or other written materials submitted by Customer or its agents or representatives); (ii) the use or combination of the Hosted Service with any other item not provided by Global UpHire where in the absence of such use or combination, the Hosted Service alone would not have given rise to the Claim; or (iii) Customer’s continued use of an infringing version of the Hosted Service when the then current version of the Hosted Service has been modified to be non-infringing.
        </p>
        <p>
          10.2 &nbsp;&nbsp;&nbsp; Indemnification by Customer. Customer shall defend, indemnify and hold Global UpHire harmless against any Claims made or brought against Global UpHire by a third party alleging that (i) Customer’s use of the Hosted Service in violation of this Agreement infringes or violates the rights of such third party; or (iii) Customer failed to comply with applicable laws, rules or regulations in its performance of this Agreement; provided, that Global UpHire (a) promptly gives written notice of the Claim to Customer; (b) gives Customer control of the defense and settlement of the Claim (provided that Global UpHire may participate in such defense at its own expense and that Customer may not settle any Claim in a manner that admits liability on behalf of Global UpHire); and (c) provides to Customer, at Customer’s expense, reasonable assistance in connection with the defense and settlement of the Claim. Customer shall pay Global UpHire any damages finally awarded against Global UpHire, settlements agreed to in accordance with Section 10.2(b) and reasonable costs and expenses (including reasonable legal fees) directly attributable to such Claim.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          12.4 &nbsp;&nbsp;&nbsp; Global UpHire’s obligations regarding information concerning Customer’s users shall be governed by the Terms and Conditions and Privacy Policy available on its website.  Global UpHire tracks activity of users and applicants for the purpose of facilitating employment and recruiting efforts.
        </p>
      </div>
      ...
      <div className="text-box">
        ...
        <p>
          14.1 &nbsp;&nbsp;&nbsp; If Customer is a federal government entity, Global UpHire provides the Hosted Service, including related software and technology, for ultimate federal government end use solely in accordance with the appropriate regulations.
        </p>
        <p>
        ...
        <p>
          14.10 &nbsp;&nbsp;&nbsp; Global UpHire may give notice by means of a Customer Notification on the Hosted Service; electronic mail to Customer’s e-mail address on record in Global UpHire’s account information, or by written communication sent by first class mail or pre-paid post to Customer’s address on the Hosted Service. Customer may give notice to Global UpHire at any time by letter sent by email to support@Global UpHire.com or by letter delivered first class mail to Global UpHire at 25 West 39th St., 7 Floor, New York, NY 10018.
        </p>
        <p>
          14.11 &nbsp;&nbsp;&nbsp; The failure of either Party to enforce any right or provision in this Agreement shall not constitute a waiver of such right or provision unless acknowledged and agreed to by such party in writing. In the event of any litigation of any controversy or dispute arising out of or in connection with this Agreement, its interpretation, its performance, or the like, the prevailing party shall be awarded reasonable attorneys’ fees and expenses, court costs, and reasonable costs for expert and other witnesses attributable to the prosecution or defense of that controversy or dispute. Any rights not expressly granted herein are reserved by Global UpHire.
        </p>
        <p>
          14.12 &nbsp;&nbsp;&nbsp; Global UpHire reserves the right to alter the terms of this Agreement at any time. If the alterations constitute a “material change” to the Agreement, Global UpHire will notify Customer. What constitutes a “material change” will be determined at Global UpHire’s sole discretion, in good faith and using common sense and reasonable judgment, but will only include those changes that materially affect Customer’s use of the Hosted Services or rights under this Agreement. Notice will be considered to have been delivered once sent.  Customer agrees to review the latest version of the Agreement on Global UpHire’s website periodically to remain aware of any non-material modifications to the Agreement about which Customer is not alerted by Global UpHire.  The Agreement available on the website will be dated so as to make clear what version is currently in force.  Any use of the Hosted Services after alteration of the Agreement will constitute acceptance by Customer of such changes. Customer’s sole remedy should Customer not agree with the altered Agreement shall be to cease Customer’s use of the Hosted Services and to comply with Customer’s termination obligations outlined in Section 11 of this Agreement.
        </p>
      </div>
    </>
  );
