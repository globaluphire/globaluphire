    ...
    return (
        <div className="text-box">
            ...
            <p>
                ...
                bat wonderfully on instantaneously eel valiantly petted this
            ...
            <p>
                ...
                pangolin horse approving paid chuckled cassowary oh above a much
                opposite far much hypnotically more therefore wasp less that hey
                apart well like while superbly orca and far hence one.Far much
                that one rank beheld bluebird after outside ignobly allegedly
                more when oh arrogantly vehement irresistibly fussy.
            </p>
        </div>
    );
};
